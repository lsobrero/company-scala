...
organization in ThisBuild := "company"
...
lazy val `company-scala` = (project in file("."))
  .aggregate(`company-api`, `company`, `inventory-api`, inventory)
...
lazy val inventory = (project in file("inventory"))
  ...
  .settings(dockerSettings)
  .dependsOn(`inventory-api`, `company-api`)
